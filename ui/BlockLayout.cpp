...
void BlockLayout::AlignInlineBlock(int height, int lineHeight, GraphicObjectIterator begin, GraphicObjectIterator end)
{
...
int BlockLayout::CalcInlineBlocks(int width, int height, GraphicObjectIterator begin, GraphicObjectIterator end, GraphicObjectIterator &newBegin)
{
    int lineHeight = 0;
    int lineWidth = 0;
    auto it = begin;
...
void BlockLayout::ReflowForward(std::shared_ptr<GraphicObject> obj, std::shared_ptr<GraphicObject> parent, std::shared_ptr<GraphicObject> widthFixedParent, std::shared_ptr<GraphicObject> heightFixedParent, int level)
{
    ...
    if ((display == "inline-block") && width.isAuto)
    {
        int childWidth = 0;
        for (auto &item : obj->children)
        {
...
void BlockLayout::Reflow(std::shared_ptr<GraphicObject> root)
{
