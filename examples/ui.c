...
static surface_t *resource_cache[sizeof(resource) / sizeof(resource[0])] = {0};

surface_t *image[3] = {0};

static void draw_svg_image(surface_t *base, int index, float vb_w, float vb_h, float w, float h, int x, int y, color_t color)
{
    if(resource_cache[index] == 0)
        resource_cache[index] = surface_svg_get(resource[index], vb_w, vb_h, w, h, color);
    
    surface_blit(base, resource_cache[index], x, y);
}
...
int sample(surface_t *base, float fps)
{
    ...
    });
    {
        ...
        draw_svg_image(base, 0, 1024, 1024, 25, 25, 42 - 12, 45 - 12, RGB(0x5864FF));
        draw_svg_image(base, 1, 1024, 1024, 45, 45, 20, 127, RGB(0xFFFFFF));
        draw_svg_image(base, 2, 1024, 1024, 35, 35, 25, 214, RGB(0xFFFFFF));
    ...
    });
    {
        ...
        });
        {
...

            {
                ...
                draw_svg_image(base, 6, 1024, 1024, 8, 8, x + 11, y + 5, RGB(0x7780AF));
                draw_svg_image(base, 7, 1024, 1024, 18, 18, x + 30, y, RGB(0xAAAFCD));
            ...
            });
            {
                ...
                draw_svg_image(base, 9, 1024, 1024, 18, 18, x + 20, y + 26, RGB(0x6B76F7));
                draw_svg_image(base, 10, 1024, 1024, 18, 18, x + 20, y + 26 + 58, RGB(0x6B76F7));
                draw_svg_image(base, 11, 1024, 1024, 18, 18, x + 20, y + 26 + 58 + 40, RGB(0x6B76F7));
                draw_svg_image(base, 12, 1024, 1024, 18, 18, x + 20, y + 26 + 58 + 40 + 40, RGB(0x6B76F7));
            ...
            });
            {
                ...
                });
                {
                    ...
                    draw_svg_image(base, 19, 1024, 1024, 12, 12, x + 13, y + 13, RGB(0xFDFEFF));
                }
            }
        }
        ...
        //Center
        {
            ...
            });
            {
                ...
                draw_svg_image(base, 8, 1024, 1024, 18, 18, x + 20, y + 15, RGB(0x6B76F7));
            ...
            });
            {
                ...
                draw_svg_image(base, 7, 1024, 1024, 32, 32, x + 17, y + 19, RGB(0x5864FF));
...

            {
                ...
                draw_svg_image(base, 13, 1024, 1024, 18, 18, x + 532 + 149, y + 2, RGB(0x858DB8));
            }

            {
                ...
                {
                    draw_svg_image(base, 18, 1024, 1024, 15, 15, x + 5, y + 6, RGB(0xFFFFFF));
                }
...

        {
...

            {
                ...
                {
                    draw_svg_image(base, 14, 1024, 1024, 18, 18, x + 15, y + 15, RGB(0x6B76F7));
                }
...

            {
                ...
                {
                    draw_svg_image(base, 15, 1024, 1024, 18, 18, x + 15, y + 15, RGB(0x16D090));
                }
...

            {
                ...
                {
                    draw_svg_image(base, 16, 1024, 1024, 15, 15, x + 15, y + 15, RGB(0xFF6760));
                }
...

            {
                ...
                {
                    draw_svg_image(base, 15, 1024, 1024, 18, 18, x + 15, y + 15, RGB(0xFDBE00));
                }
...

            {
                ...
                {
                    draw_svg_image(base, 17, 1024, 1024, 18, 18, x + 15, y + 15, RGB(0x6194FF));
                }
